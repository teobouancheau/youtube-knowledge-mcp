  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        'src/utils/file-lock.ts': { lines: 100, functions: 100, branches: 93, statements: 100 },
        'src/utils/channel-lookup.ts': {
          lines: 100,
          functions: 100,
          branches: 93,
          statements: 100,
        ...
        'src/utils/image-fetch.ts': { lines: 100, functions: 100, branches: 90, statements: 100 },
        'src/utils/thumbnail-*.ts': { lines: 100, functions: 100, branches: 92, statements: 100 },
        'src/utils/flat-listing.ts': { lines: 100, functions: 100, branches: 93, statements: 100 },
        'src/utils/channel-images.ts': {
          lines: 100,
          functions: 100,
          branches: 93,
          statements: 100,
        ...
        'src/registry/**': { lines: 100, functions: 100, branches: 100, statements: 100 },
        'src/utils/chapters.ts': { lines: 100, functions: 100, branches: 100, statements: 100 },
        'src/utils/batches.ts': { lines: 100, functions: 100, branches: 100, statements: 100 },
